...
public class QuiverGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public boolean IsProjectile(ItemStack _itemstack)
	{
		Item _item = _itemstack.getItem();

		return _item == Items.ARROW || _item == Items.FIREWORK_ROCKET || _item == Items.SPECTRAL_ARROW || _item == Items.TIPPED_ARROW;
	}

	public QuiverGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EnhancingModMenus.QUIVER_GUI.get(), id);
